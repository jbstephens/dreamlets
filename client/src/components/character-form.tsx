...
export function CharacterForm() {
  ...
  const createKidMutation = useMutation({
    mutationFn: async (kid: { name: string; age: number; description?: string; hairColor?: string; eyeColor?: string; hairLength?: string; skinTone?: string }) => {
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-3 mb-4">
          ...
          <Dialog open={isCharacterDialogOpen} onOpenChange={setIsCharacterDialogOpen}>
            ...
            <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-[425px] max-w-[90vw] top-[10vh] sm:top-[50%] translate-y-0 sm:translate-y-[-50%]">
              <DialogHeader>
